...
<!-- Pediatric Dentistry HERO FIRST SECTION -->
        ...
        <div class="row rootcanal_first_section_row g-0">
            ...
            <div class="col-lg-5 col-md-12 rootcanal_first_section_left ps-3 ps-lg-4">
                ...
                <div class="rootcanal_first_section_breadcrumb">
                    ...
                    <span>&gt;</span>
                    <span class="rootcanal_first_section_active">Pediatric Dentistry</span>
                </div>

                <!-- Main Section Title -->
                <h1 class="rootcanal_first_section_title">
                    Pediatric Dentistry<br>Treatment
                </h1>
...
<!-- Pediatric Dentistry SECOND SECTION (BENEFITS BAR) -->
...
<!-- Pediatric Dentistry THIRD SECTION (ABOUT & HIGHLIGHT QUOTE) -->
...
<!-- Pediatric Dentistry FIFTH SECTION (3-CARD SECTION) -->
<section class="rootcanal_fifth_section_wrapper">
    <div class="container">
        <div class="row">
                    ...
                    <div>
                        ...
                        <div class="rootcanal_fifth_section_ba_grid">
                            ...
                            <div class="rootcanal_fifth_section_ba_box">
                                <img src="./assets/img/Before-pediatric.png" alt="Before Pediatric Dentistry Treatment">
                                <span class="rootcanal_fifth_section_ba_badge">Before</span>
                            </div>

                            <!-- After Image -->
                            <div class="rootcanal_fifth_section_ba_box">
                                <img src="./assets/img/after-pediatric.png" alt="After Pediatric Dentistry Treatment">
            ...
            <!-- CARD 2: BENEFITS OF Pediatric Dentistry -->
            <div class="col-lg-4 col-md-12 rootcanal_fifth_section_col">
                <div class="rootcanal_fifth_section_card">
                    <div>
                        <h3 class="rootcanal_fifth_section_title">BENEFITS OF Pediatric Dentistry</h3>
                        <div class="rootcanal_fifth_section_divider">
                            <div class="rootcanal_fifth_section_divider_line"></div>
                            <div class="rootcanal_fifth_section_divider_dot"></div>
                        </div>
            ...
            <div class="rootcanal_fifth_section_faq_list">
                ...
                <div class="rootcanal_fifth_section_faq_item">
                    ...
                    <div class="faq_answer">
                        <strong>Usually,</strong> by the first birthday.
                    </div>
                ...
                <div class="rootcanal_fifth_section_faq_item">
                    ...
                    <!-- Answer -->
                    <div class="faq_answer">
                        <strong>Usually,</strong> every six months.
                    </div>
                ...
                <div class="rootcanal_fifth_section_faq_item">
                    ...
                    <!-- Answer -->
                    <div class="faq_answer">
                        <strong>Yes,</strong> brushing and limiting sugary foods help prevent cavities.
                    </div>
                ...
                <div class="rootcanal_fifth_section_faq_item">
                    ...
                    <!-- Answer -->
                    <div class="faq_answer">
                        <strong>Yes,</strong> treatments are safe when properly planned.
                    </div>
...
<!-- Pediatric Dentistry SIXTH SECTION (CTA BANNER BAR) -->
