...
<head>
    ...
    <style>
        ...
        .badge_service_name {
            background-color: #024237 !important;
            color: white;
            font-weight: bold;
            border-radius: 5px;
        }
        ...
        .button-for-change{
            border: 2px solid #024237 !important;
    ...
    <main class="fullblogs_section">
        <div class="container py-5">
            <div class="d-flex justify-content-center mb-4">
                <button id="english-btn" class="lang-btn active btn button-for-change ">English</button>
                <button id="telugu-btn" class="lang-btn ms-3 btn button-for-change">తెలుగు</button>
            </div>
