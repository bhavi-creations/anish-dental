        ...
        <div class="row rootcanal_first_section_row g-0">
            ...
            <div class="col-lg-5 col-md-12 rootcanal_first_section_left ps-3 ps-lg-4">
                ...
                <div class="rootcanal_first_section_breadcrumb">
                    ...
                    <span>&gt;</span>
                    <span class="rootcanal_first_section_active">Periodontal Care Treatment</span>
                </div>

                <!-- Main Section Title -->
                <h1 class="rootcanal_first_section_title">
                    Periodontal Care<br>Treatment
                </h1>
...
<!-- Periodontal Care SECOND SECTION (BENEFITS BAR) -->
...
<!-- Periodontal Care THIRD SECTION (ABOUT & HIGHLIGHT QUOTE) -->
        ...
        <div class="row rootcanal_third_section_row">
            ...
            <div class="col-lg-6 col-md-12 rootcanal_third_section_left">
                ...
                <h2 class="rootcanal_third_section_heading">
                    ABOUT Periodontal Care TREATMENT
                </h2>
...
<!-- Periodontal Care FOURTH SECTION (PROCESS STEPS FLOW) -->
...
<section class="rootcanal_fifth_section_wrapper">
    <div class="container">
        <div class="row">
            ...
            <!-- CARD 2: BENEFITS OF Periodontal Care -->
            <div class="col-lg-4 col-md-12 rootcanal_fifth_section_col">
                <div class="rootcanal_fifth_section_card">
                    <div>
                        <h3 class="rootcanal_fifth_section_title">BENEFITS OF Periodontal Care</h3>
                        <div class="rootcanal_fifth_section_divider">
                            <div class="rootcanal_fifth_section_divider_line"></div>
                            <div class="rootcanal_fifth_section_divider_dot"></div>
                        </div>
            ...
            <div class="rootcanal_fifth_section_faq_list">
                ...
                <div class="rootcanal_fifth_section_faq_item">
                    ...
                    <div class="faq_answer">
                        <strong>It treats</strong> gum disease and helps maintain healthy gums.
                    </div>
                ...
                <div class="rootcanal_fifth_section_faq_item">
                    ...
                    <!-- Answer -->
                    <div class="faq_answer">
                        <strong>No,</strong> treatment is usually comfortable with proper care.
                    </div>
                ...
                <div class="rootcanal_fifth_section_faq_item">
                    ...
                    <!-- Answer -->
                    <div class="faq_answer">
                        <strong>Usually,</strong> treatment takes a few visits.
                    </div>
                ...
                <div class="rootcanal_fifth_section_faq_item">
                    ...
                    <!-- Answer -->
                    <div class="faq_answer">
                        <strong>Yes,</strong> brushing, flossing, and regular check-ups help prevent it.
                    </div>
